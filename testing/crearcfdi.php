...
satxmlsv22_cargaAtt($emisor, array("rfc"=>"AAD990814BP7",
...
$file="aad990814bp7_1210261233s.key.pem";      // Ruta al archivo
...
$file="aad990814bp7_1210261233s.cer.pem";      // Ruta al archivo de Llave publica
$datos = file($file);
