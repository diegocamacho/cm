    ...
    <div class="container-fluid">
        ...
        <div class="page-header page-header-block">
            <div class="page-header-section">
                <h4 class="title semibold">Facturas Recibidas de Mayo</h4>
            </div>
                ...
                <div class="table-layout">
                    ...
                    <div class="col-xs-8 panel">
                        <div class="panel-body text-center">
                            ...
                            <p class="semibold text-muted mb0 mt5">EGRESOS FACTURADOS</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="table-layout">
                    ...
                    <div class="col-xs-8 panel">
                        <div class="panel-body text-center">
                            ...
                            <p class="semibold text-muted mb0 mt5">FACTURAS RECIBIDAS</p>
                        </div>
                    </div>
                </div>
                <!--/ END Statistic Widget -->
            ...
            <div class="col-md-12">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">Facturas Recibidas de Mayo</h3>
                    </div>
                    ...
                    <table class="table table-striped" id="zero-configuration">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>500.00</td>
                                <td><span class="label label-default">Vigente</span></td>
                                <td>
