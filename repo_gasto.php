    ...
    <div class="container-fluid">
        ...
        <div class="page-header page-header-block">
            <div class="page-header-section">
                <h4 class="title semibold">Reporte de Gastos por Fecha</h4>
            </div>
            <div class="page-header-section">
                <!-- Toolbar -->
                <div class="toolbar">
			...
			<div class="col-md-12">
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="ico-user-md mr5"></i> Reporte de Gastos por Fecha</h3>
                    </div>
                    <!--/ panel heading/header -->
...
$('#btn_guarda').click(function(){
        ...
        if(fecha_inicio && fecha_fin){
            ...
            $('#fecha_fin').val('');
            window.open(
                "/cm/formatos/gastos.php?fecha_ini="+fecha_inicio+"&fecha_fin="+fecha_fin,
                "_blank"
            );
        }else{
