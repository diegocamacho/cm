...
$sql="SELECT * FROM ingresos WHERE id_medico=$id_medico AND activo = 1 AND fecha_hora_captura>='$fecha_inicio' AND fecha_hora_captura<='$fecha_fin' ORDER BY id_ingreso ASC";
$q=mysql_query($sql);
...
<!-- header -->	
	...
	<table class="page_header">
		...
		<tr>
			<td align="center" style="width: 100%;font-size: 18px;">REPORTE DE INGRESOS DEL <?=strtoupper(fechaLetra($fecha_inicio))?> AL <?=strtoupper(fechaLetra($fecha_fin))?></td>
		</tr>
	</table>
	</page_header>
<!-- Footer -->
...
<br/><br/>
	<table style="width: 100%;" width="1300" align="center" border=".5" cellpadding="0" cellspacing="0" class="cal">
		<tr>
			<th width="80" align="center"># Ingreso</th>
		...
		<? while($ft=mysql_fetch_assoc($q)){ ?>
				        <tr id="tr_<?=$ft['id_ingreso']?>">
				        	<td align="center"><?=str_pad($ft['id_ingreso'],4,"0",STR_PAD_LEFT)?></td>
				          	<td align="center"><?=date('d-M-Y',strtotime($ft['fecha_hora_captura']))?></td>
				          	<td align="center"><?=nombreClinica($ft['id_clinica'])?></td>
				          	<td align="center"><?=$ft['anotacion']?></td>
...
<div style="width:100%;text-align:center">	
	<h2>GRAN TOTAL INGRESOS: $<?=number_format($gran_total,2)?> </h2>	
</div>
